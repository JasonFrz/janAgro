      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            ...
            <div className="flex space-x-3">
              {[Facebook, Instagram, Twitter, Youtube].map((Icon, idx) => (
                <a
                  key={idx}
                  href="#"
                  className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center hover:bg-white hover:text-black transition-all duration-300"
                >
                  <Icon size={14} />
                </a>
              ))}
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li>
                <Link
                  to="/shop"
                  className="text-white font-medium hover:underline mt-2 inline-block"
                >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="px-6 py-3 bg-white text-black font-bold rounded-lg hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p className="mb-4 md:mb-0 text-center md:text-left">
            &copy; {new Date().getFullYear()} Jan Agro Nusantara. All rights
            reserved.
          </p>
