          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-black focus:border-transparent outline-none"
                  required
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-black outline-none bg-white"
                  required
                >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <label
                      ...
                      className="w-full sm:w-auto bg-blue-600 text-white px-4 py-2.5 rounded-md hover:bg-blue-700 text-sm font-medium cursor-pointer flex items-center justify-center transition-colors"
                    >
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  placeholder="Full product specifications..."
                  value={form.detail}
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <button
                ...
                className={`flex-1 justify-center bg-black text-white px-6 py-3 rounded-md font-bold flex items-center transition-all ${
                  isFormInvalid
              ...
              {editingId && (
                <button
                  ...
                  className="flex-1 justify-center bg-white text-gray-700 border border-gray-300 px-6 py-3 rounded-md font-bold hover:bg-gray-50 flex items-center transition-all"
                >
            ...
            <div className="overflow-x-auto overflow-y-auto max-h-[450px] rounded-lg border border-gray-200">
              <table className="w-full border-collapse min-w-[700px]">
                <thead className="bg-gray-50 sticky top-0 z-10 shadow-sm">
                  <tr>
                    <th className="p-3 text-left font-semibold text-gray-600 border-b w-20">
                      Image
                    </th>
                    <th className="p-3 text-left font-semibold text-gray-600 border-b">
                      Product Name
                    </th>
                    <th className="p-3 text-left font-semibold text-gray-600 border-b w-32">
                      Category
                    </th>
                    <th className="p-3 text-right font-semibold text-gray-600 border-b w-32">
                      Price
                    </th>
                    <th className="p-3 text-center font-semibold text-gray-600 border-b w-24">
                      Stock
                    </th>
                    <th className="p-3 text-center font-semibold text-gray-600 border-b w-32">
                      Actions
                    </th>
                  </tr>
                </thead>
                    ...
                    >
                      <td className="p-3">
                        {p.image ? (
                          ...
                          <div className="w-12 h-12 bg-gray-100 rounded flex items-center justify-center text-[10px] text-gray-400 border border-gray-200">
                            No IMG
                          </div>
                        )}
                      </td>
